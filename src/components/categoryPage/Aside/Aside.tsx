...
export function Aside({ isFilterButtonClicked }: Readonly<AsideProps>) {
  return (
    <aside
      className={`${
        isFilterButtonClicked ? "" : "hidden"
      } pt-4 lg:pt-0 lg:flex flex-col w-full lg:w-1/4 border-2 border-gray-300 h-full px-4 py-2 rounded-xl gap-4`}
    >
