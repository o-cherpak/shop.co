...
export function PageNavigator({productsLength}: Readonly<PageNavigatorProps>) {
  ...
  return (
    <div
      className="flex justify-between px-2 pt-10 pb-6 relative before:absolute
      before:bottom-22 before:left-0 before:content-[''] before:w-full before:h-[1px] before:bg-gray-300">
